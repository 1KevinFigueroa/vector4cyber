...
The problem with Amass' output to a text file will be structured subdomains in a list. When the output in a JSON file

### Usage:
convert_AmassTXT2JSON.py [-h] input_file output_file

### Amass TEXT file structure output example ❌
